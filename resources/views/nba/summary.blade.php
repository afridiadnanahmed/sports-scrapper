                    ...
                    <div class="live-match-wrap">
                        ...
                        <ul class="list-inline table-list">
                            <li class="country-status">
                                ...
                                <span class="score-status"><b>{{ ($summary['teamInfo']['team1']['points']) }}</b></span>
                            </li>
                            ...
                            <li class="country-status right">
                                ...
                                <span class="score-status"><b>{{ ($summary['teamInfo']['team2']['points']) }}</b></span>
                            </li>
                        </ul>
                        ...
                        <div role="tabpanel">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="media summary-media">
                                                <div class="pull-left left-col col-sm-3">
                                                    <span class="min">{{ $sum['points'] }}</span>
                                ...
                                <div role="tabpanel" class="tab-pane row" id="squad-filter">
                                    ...
                                    <div class="col-sm-6">
                                        <ul class="group-list">
                                            <li class="info-bg">{{ $summary['teamInfo']["team$si"]["name"] }}</li>
                                            @foreach($summary['summary'] as $pi => $player)
                                            @if($summary['teamInfo']["team$si"]["name"] != $player['team'])
                                                @break
                                            @endif
                                            <li>{{ $player['player'] }}</li>
                                            @unset($summary['summary'][$pi])
                                            @endforeach
                                        </ul>
                                    </div>
                                    @endfor
